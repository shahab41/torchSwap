...
const ShareButton = ({ code }: any) => {
  ...
  const handleShare = () => {
    const shareText = `Hey Bro, I am gifting you 2500 Tourch Swap tokens, Let's become millionaire ${shareLink}`;
  ...
  return (
    <button
      onClick={handleShare}
      className="py-4  px-5 w-[90%] mx-auto rounded-xl bg-white text-gray-700 font-semibold"
    >
      Invite Freinds
    </button>
  );
